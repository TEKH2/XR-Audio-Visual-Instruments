...
//        }
    ...
    // CHRIS 18/10/2020 --- ADDED THESE POINTERS TO FIX BELOW CODE
    vector<float>* sumRealPtr = &sumReal;
    vector<float>* sumImagPtr = &sumImag;

    return ifft.process(sumImagPtr[0], sumImagPtr[0], maxiIFFT::COMPLEX);
}
