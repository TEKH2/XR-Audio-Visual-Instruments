...
namespace Obi{
	...
	public class ObiCharacter : MonoBehaviour {
		...
		Animator m_Animator;
		ObiAnimatorController m_AnimatorController;
		bool m_IsGrounded;
		...
		public void OnAnimatorMove()
		{
			...
			if (m_IsGrounded && (m_AnimatorController == null || m_AnimatorController.UpdateDelta > 0))
			{
				Vector3 v = (m_Animator.deltaPosition * m_MoveSpeedMultiplier) / (m_AnimatorController == null? Time.deltaTime : m_AnimatorController.UpdateDelta);
