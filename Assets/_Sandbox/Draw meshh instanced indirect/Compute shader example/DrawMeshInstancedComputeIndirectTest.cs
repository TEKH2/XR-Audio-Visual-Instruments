...
public class DrawMeshInstancedComputeIndirectTest : MonoBehaviour
{
    ...
    ComputeTransform[] tempTFroms;
    public int getIndex = 10;
    void Update()
    {
        ...
        // Get data back
        m_ModifiedTransformBuffer.GetData(tempTFroms);
        //print(tempTFroms[getIndex].position + "    " + tempTFroms[getIndex].rotation + "      " + tempTFroms[getIndex].scale);

        m_InstMat.SetBuffer("ModifiedTransformBuffer", m_ModifiedTransformBuffer);

        // m_ModifiedTransformBuffer.GetData(tempTFroms);
        // print(tempTFroms[getIndex].rotation);
    ...
    void UpdateBuffers()
    {
        ...
        tempTFroms = new ComputeTransform[m_InstCount];
