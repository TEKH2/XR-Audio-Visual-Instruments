...
namespace EXP.Painter
{
    ...
    public class PainterManager : MonoBehaviour
    {
        ...
        public PainterResourceManager m_ResourceManager;
        ...
        List<PainterCanvas> m_AllCanvases = new List<PainterCanvas>();
        int m_ActiveCanvasIndex = 0;
        PainterCanvas m_ActiveCanvas;
        public PainterCanvas ActiveCanvas { get { return m_ActiveCanvas; } set { m_ActiveCanvas = value; } }
        public List<PainterCanvas> AllCanvases { get { return m_AllCanvases; } }
        Transform m_CanvasParent;
        public Transform CanvasParent { get { return m_CanvasParent; } }
        #endregion       

        #region Undo/Redo
        Stack<BrushStroke> m_ActiveStrokeStack = new Stack<BrushStroke>();
        Stack<BrushStroke> m_UndoStack = new Stack<BrushStroke>();
        #endregion
        ...
        {
            PainterCanvas newCanvas = new GameObject("_Canvas " + m_AllCanvases.Count).AddComponent<PainterCanvas>();
        ...
        private void ActiveBrush_OnStrokeCompleteEvent(BrushStroke stroke)
        {
            m_StrokeCount++;
        ...
        public void UndoLastStroke()
        {
            if (m_ActiveStrokeStack.Count > 0)
            {
                ...
                BrushStroke stroke = m_ActiveStrokeStack.Pop();
                m_UndoCount++;
                ...
                { 
                    ...
                    m_ActiveCanvas.UndoStroke(stroke);
                }
                else
                {
        ...
        public void Redo()
        {
            ...
            {
                BrushStroke stroke = m_UndoStack.Pop();
                m_ActiveStrokeStack.Push(stroke);

                m_ActiveCanvas.RedoStroke(stroke);
        ...
        {
            foreach (BrushStroke s in m_UndoStack)
